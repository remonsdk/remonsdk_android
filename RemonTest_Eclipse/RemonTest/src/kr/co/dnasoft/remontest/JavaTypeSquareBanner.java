 ...
 */
public class JavaTypeSquareBanner extends Activity {
    ...
    private void initRemon() {
		 ...
		 * 									Listener
		 ====================================================*/
        //광고 클릭시 실행될 Listener
        adView.setOnAdClickedListener(new AdView.OnAdClickClickedListener() {
            @Override
        ...
        adView.setOnAdFailedListener(new AdView.OnAdFailedListener() {
            ...
            @Override
            public void OnAdFailed(AdConstant.ADErrorCode arg0, String arg1) {
        ...
        adView.setcId("MTQyODkzNTI2NTcyNjE2");
        ...
        //adView.testAdType = ADType.SQUARE;
